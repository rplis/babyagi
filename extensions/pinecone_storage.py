...
assert can_import("pinecone"), (
    "\033[91m\033[1m"
    + "Pinecone storage requires package pinecone-client.\nInstall:  pip install -r extensions/requirements.txt"
)
...
class PineconeResultsStorage:
    def __init__(
        ...
        assert (
            dimension == index_stats_response["dimension"]
        ), "Dimension of the index does not match the dimension of the LLM embedding"
